...
<html lang="en">
	<head>
		<title>Recuperación de contraseña del paciente</title>
	...
	<body class="login">
		<div class="row">
			<div class="main-login col-xs-10 col-xs-offset-1 col-sm-8 col-sm-offset-2 col-md-4 col-md-offset-4">
				...
				<a href="../index.html"><h2> S.G.D.H | Recuperación de contraseña del paciente</h2></a>
				</div>
				...
				<div class="box-login">
					<form class="form-login" method="post">
						<fieldset>
							...
							<p>
								Por favor ingrese su correo electrónico y nombre completo para recuperar su contraseña.<br />
