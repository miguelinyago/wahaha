	...
	<body class="login">
		...
		<div class="row">
			<div class="main-login col-xs-10 col-xs-offset-1 col-sm-8 col-sm-offset-2 col-md-4 col-md-offset-4">
				...
				<a href="../index.html"><h2>S.G.D.H. | Registro de Pacientes</h2></a>
				</div>
				<!-- start: REGISTER BOX -->
				<div class="box-register">
						...
						<fieldset>
							...
							<div class="form-group">
								...
								<div class="clip-radio radio-primary">
									<input type="radio" id="rg-feMasculino" name="gender" value="Femenino" >
									<label for="rg-feMasculino">
										Femenino
									</label>
									<input type="radio" id="rg-Masculino" name="gender" value="masculino">
									<label for="rg-Masculino">
										Masculino
									</label>
								</div>
							</div>
					...
					<div class="copyright">
						&copy; <span class="current-year"></span><span class="text-bold text-uppercase"> O.H. LA UNION-SERVISOPORT MEDICAL</span>. <span> Todos los derechos Reservados</span>
					</div>
