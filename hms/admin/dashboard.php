				...
				<div class="main-content" >
					<div class="wrap-content container" id="container">
						...
						<section id="page-title">
							<div class="row">
								<div class="col-sm-8">
									<h1 class="mainTitle">Administracion  | Inicio</h1>
																	</div>
								<ol class="breadcrumb">
									<li>
						...
						<!-- start: BASIC EXAMPLE -->
							...
							<div class="row">
								<div class="col-sm-4">
									<div class="Inicio Inicio-white no-radius text-center">
										<div class="Inicio-body">
											<span class="fa-stack fa-2x"> <i class="fa fa-square fa-stack-2x text-primary"></i> <i class="fa fa-smile-o fa-stack-1x fa-inverse"></i> </span>
											<h2 class="StepTitle">Manejo de Usuarios </h2>
								...
								<div class="col-sm-4">
									<div class="Inicio Inicio-white no-radius text-center">
										<div class="Inicio-body">
											...
											<h2 class="StepTitle">Manejar Doctores</h2>
...
<div class="col-sm-4">
									<div class="Inicio Inicio-white no-radius text-center">
										<div class="Inicio-body">
											<span class="fa-stack fa-2x"> <i class="fa fa-square fa-stack-2x text-primary"></i> <i class="fa fa-smile-o fa-stack-1x fa-inverse"></i> </span>
											<h2 class="StepTitle">Manejo de Pacientes</h2>
			...
			<div class="col-sm-4">
									<div class="Inicio Inicio-white no-radius text-center">
										<div class="Inicio-body">
											...
											<h2 class="StepTitle">Nuevas Colsultas</h2>
...
?>
											Total de Nuevas Colsultas :<?php echo htmlentities($num_rows22);   ?>	
												</a>
												</a>
											</p>
										</div>
