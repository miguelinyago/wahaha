...
<html lang="en">
	<head>
		<title>Administracion | Editar Especialización del Doctor</title>
				...
				<div class="main-content" >
					<div class="wrap-content container" id="container">
						...
						<section id="page-title">
							<div class="row">
								<div class="col-sm-8">
									<h1 class="mainTitle">Administracion | Editar Especialización del Doctor</h1>
																	</div>
								<ol class="breadcrumb">
									<li>
										...
										<div class="col-lg-6 col-md-12">
											<div class="Inicio Inicio-white">
												<div class="Inicio-heading">
													<h5 class="Inicio-title">Editar Especialización del Doctor</h5>
												</div>
