...
<html lang="en">
	<head>
		<title>Administracion | Cambiar Contraseña</title>
		<meta charset="utf-8" />
				...
				<div class="main-content" >
					<div class="wrap-content container" id="container">
						...
						<section id="page-title">
							<div class="row">
								<div class="col-sm-8">
									<h1 class="mainTitle">Administracion | Cambiar la contraseña</h1>
																	</div>
								<ol class="breadcrumb">
									<li>
										...
										<div class="col-lg-8 col-md-12">
											<div class="Inicio Inicio-white">
												<div class="Inicio-heading">
													<h5 class="Inicio-title">Cambiar la contraseña</h5>
												</div>
...
<div class="form-group">
									...
									<input type="password" name="cfpass" class="form-control"  placeholder="Ingrese de Nuevo la Contraseña">
														</div>
