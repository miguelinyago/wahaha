...
<html lang="en">
	<head>
		<title>Administracion | Agregar Doctor</title>
            ...
            <div class="main-content">
                <div class="wrap-content container" id="container">
                    <section id="page-title">
                        <div class="row">
                            <div class="col-sm-8">
                                <h1 class="mainTitle">Administracion | Agregar Doctor</h1>
                            </div>
                            <ol class="breadcrumb">
                                <li>
                                        ...
                                        <div class="panel panel-white">
                                            ...
                                            <div class="panel-body">
                                                <form role="form" name="adddoc" method="post" onSubmit="return valid();">
                                                    ...
                                                    <div class="form-group">
                                                        <label for="address">Dirección de la Clínica del Doctor</label>
                                                        <textarea name="clinicaddress" class="form-control" placeholder="Ingrese la Dirección de la Clínica del Doctor" required="true"></textarea>
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="fess">Numero de Colsultorio</label>
                                                        <input type="text" name="docfees" class="form-control" placeholder="Ingrese el Numero de Colsultorio" required="true">
                                                    </div>
                                                    <div class="form-group">
