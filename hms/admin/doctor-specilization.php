...
<html lang="en">
	<head>
		<title>Administracion | Especialización del doctor</title>
				...
				<div class="main-content" >
					<div class="wrap-content container" id="container">
						...
						<section id="page-title">
							<div class="row">
								<div class="col-sm-8">
									<h1 class="mainTitle">Administracion |  Especialización del doctor</h1>
																	</div>
								<ol class="breadcrumb">
									<li>
										...
										<div class="col-lg-6 col-md-12">
											<div class="Inicio Inicio-white">
												<div class="Inicio-heading">
													<h5 class="Inicio-title">Especialización del doctor</h5>
												</div>
													...
													<form role="form" name="dcotorspcl" method="post" >
														<div class="form-group">
															<label for="exampleInputEmail1">
																Agregar Especialización del doctor
															</label>
							<input type="text" name="doctorspecilization" class="form-control"  placeholder="Ingrese la Especialización del doctor">
														</div>
									...
									<div class="row">
								<div class="col-md-12">
									<h5 class="over-title margin-bottom-15">Manejar <span class="text-bold">Especialización del doctor</span></h5>
