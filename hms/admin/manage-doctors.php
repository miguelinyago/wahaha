...
<html lang="en">
	<head>
		<title>Administracion | Manejar Doctores</title>
				...
				<div class="main-content" >
					<div class="wrap-content container" id="container">
						...
						<section id="page-title">
							<div class="row">
								<div class="col-sm-8">
									<h1 class="mainTitle">Administracion | Manejar Doctores</h1>
																	</div>
								<ol class="breadcrumb">
									<li>
						...
						<div class="container-fluid container-fullw bg-white">
									...
									<div class="row">
								<div class="col-md-12">
									<h5 class="over-title margin-bottom-15">Manejar <span class="text-bold">Doctores</span></h5>
									...
									<table class="table table-hover" id="sample-table-1">
										<thead>
											<tr>
												...
												<th class="hidden-xs">Nombre del Medico</th>
