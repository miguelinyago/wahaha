...
<html lang="en">
	<head>
		<title>E/F Informes de Fecha  | Administracion</title>
				...
				<div class="main-content" >
					<div class="wrap-content container" id="container">
						...
						<section id="page-title">
							<div class="row">
								<div class="col-sm-8">
									<h1 class="mainTitle">Informes de Fecha | Reportes</h1>
																	</div>
								<ol class="breadcrumb">
									<li>
										<span>Informes de Fecha</span>
									</li>
									<li class="active">
										<span>Reportes</span>
									</li>
										...
										<div class="col-lg-8 col-md-12">
											<div class="Inicio Inicio-white">
												<div class="Inicio-heading">
													<h5 class="Inicio-title">Informes de Fecha</h5>
												</div>
