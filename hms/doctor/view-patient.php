...
<div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    ...
    <th>Glucometria :</th>
    <td>
    <input name="bs" placeholder="Glucometria" class="form-control wd-450" required="true"></td>
  </tr> 
  <tr>
    <th>Peso: </th>
    <td>
  ...
  <tr>
    <th>Temperatura corporal :</th>
    <td>
    <input name="temp" placeholder="Glucometria" class="form-control wd-450" required="true"></td>
  </tr>
